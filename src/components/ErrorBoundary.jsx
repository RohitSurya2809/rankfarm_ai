    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-50">
      <div className="text-center p-8 max-w-md">
        ...
        <div className="flex flex-col gap-1 text-center">
          <h1 className="text-2xl font-medium text-neutral-800">{t("errors.somethingWentWrong")}</h1>
          <p className="text-neutral-600 text-base w w-8/12 mx-auto">{t("errors.unexpectedError")}</p>
        </div>
