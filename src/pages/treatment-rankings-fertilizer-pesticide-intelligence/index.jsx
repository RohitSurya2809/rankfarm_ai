...
const TreatmentRankingsPage = () => {
  ...
  const handleVoiceResult = (result) => {
    console.log("[v0] Voice search result for treatments:", result)
  ...
  const filteredTreatments = currentTreatments?.filter((treatment) => {
    ...
    const matchesRegion =
      !selectedRegion ||
      treatment?.topRegions?.some((region) => region?.toLowerCase()?.includes(selectedRegion?.replace("-", " ")))
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Data-driven rankings of fertilizers, pesticides, fungicides, and herbicides. Compare treatments, calculate ROI, and get expert recommendations for optimal crop protection and nutrition."
        />
        <meta
          name="keywords"
          content="fertilizer rankings, pesticide intelligence, crop treatment, agricultural inputs, ROI calculator, expert recommendations"
        />
      </Helmet>
      <Header />
      <main className="pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold">Treatment Rankings</h1>
              </div>
              <p className="text-xl text-green-100 max-w-3xl mx-auto leading-relaxed">
                Transform complex agricultural input decisions into clear, data-driven recommendations. Compare
                fertilizers, pesticides, and treatments with scientific precision.
              </p>
            </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                        <VoiceInputButton
                          ...
                          placeholder="Speak treatment name or type"
        ...
        <section className="bg-gradient-to-r from-primary to-secondary py-16">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Optimize Your Treatment Strategy?</h2>
            <p className="text-xl text-green-100 mb-8 leading-relaxed">
              Get personalized treatment recommendations based on your crop, soil, and regional conditions. Start making
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                Empowering farmers with data-driven treatment recommendations and scientific insights for optimal crop
                protection and nutrition management.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>
              &copy; {new Date()?.getFullYear()} RankFarm AI. All rights reserved. | Transforming agriculture through
